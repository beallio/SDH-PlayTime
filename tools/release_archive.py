...
VENDORED_PYYAML_FILE_HASHES = {
    "yaml/__init__.py": (
        "b19dfcc333d6a75dfd73073901164507252f271b41d3b5f7d85510033a0547a7"
    ),
    "yaml/composer.py": (
    ...
    "pyyaml-6.0.3.dist-info/METADATA": (
        "03c3b415ed38d09faedc49360e930769b40c58f68585e6de00e2e4916a858d34"
    ),
...
REQUIRED_RUNTIME_FILES = (
    ...
    "py_modules/game_resolution/checksum.py",
