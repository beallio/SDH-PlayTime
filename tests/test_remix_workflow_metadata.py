...
class RemixWorkflowMetadataTests(unittest.TestCase):
        ...
        self.assert_successful_outputs(
            {
                ...
                "GITHUB_REF_TYPE": "tag",
                "GITHUB_REF_NAME": "v3.3.1-beallio.11",
            },
            "3.3.1-beallio.11",
            "SDH-PlayTime-beallio-remix-v3.3.1-beallio.11.zip",
        )
    ...
    def test_push_derives_date_stamped_nightly_metadata(self) -> None:
        ...
        self.assertIn(
            outputs.get("version"),
            {
                f"3.3.1-beallio.11.dev.{before}.g1a2b3c4",
                f"3.3.1-beallio.11.dev.{after}.g1a2b3c4",
            },
        )
        self.assertEqual(
    ...
    def test_manual_dispatch_derives_stable_release_metadata(self) -> None:
        self.assert_successful_outputs(
            ...
            "3.3.1-beallio.11",
            "SDH-PlayTime-beallio-remix-manual-3.3.1-beallio.11.zip",
        )
